...
import FireworksBackgroundDemo from "@/components/demo-components-backgrounds-fireworks";
import { GreenTitle, GrayTitle, SectionHeading, SectionLabel } from "@/components/reusable";
...
export function BentoCard({ icon, title, desc, children, className = "" }) {
  return (
    <div
      className={`relative bg-[#0f0f11] border border-white/10 hover:border-greeb-400/20 rounded-2xl p-9 h-full transition duration-300 overflow-hidden ${className}`}
    >
      <div className="absolute inset-0 bg-linear-to-br from-green-400/5 via-transparent pointer-events-none" />
    ...
    <div className="bg-black overflow-x-hidden">
      <section className="relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pt-28 sm:pt-32 pb-20 overflow-hidden">
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2">
          ...
          <h1 className="font-serif relative text-5xl sm:text-6xl lg:text-7xl tracking-tighter max-w-4xl">
            <GrayTitle>Master Your Next Interview</GrayTitle>
            <br />
            <GreenTitle>with real experts</GreenTitle>
          </h1>

          <p className="relative text-sm sm:text-base md:text-lg text-black-400 max-w-xl mt-6 leading-relaxed">
            Train smarter with AI-powered mock interviews, detailed feedback, and personalized coaching to help you secure your next offer.
          </p>
          ...
          <div className="relative flex items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-16">
            ...
            <p className="text-sm text-stone-500 text-center sm:text-left">
              <strong className="text-stone-400 font-medium">
                Helping future engineers become interview ready
              </strong>{" "}
        ...
        <div className="col-span-full lg:col-span-2 flex items-center justify-center lg:justify-start mt-12 lg:mt-0 lg:rotate-3">
          ...
          <CodeDemo duration={5000} writing={true} cursor={true} />
        </div>
      </section>
          ...
          <div className="col-span-12 md:col-span-7">
            ...
            >
              <div className="flex flex-wrap gap-2 mt-5">
                {AI_TAGS.map((t) => (
                  <Badge key={t.label} variant={t.active ? "secondary" : "outline"}>
                    {t.label}
                  </Badge>
                ))}
              </div>
            ...
            >
              <div className="mt-5 rounded-xl bg-[#141417] border border-white/10 p-5 flex justify-between items-end">
                <div>
                  ...
                  <p className="font-serif text-4xl leading-none bg-linear-to-br from-green-300 to-green-500 bg-clip-text text-transparent">
                    28
                  </p>
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <SectionHeading gray="Built for both sides" green="of the table" />
        </div>
        <div className="grid md:grid-cols-2 gap-6">
          {ROLES.map((role) => (
            <div key={role.label} className="relative bg-[#0f0f11] border border-white/10 hover:border-gray-400/20 rounded-2xl p-12 h-full transition duration-300 overflow-hidden">

              <span className="inline-block text-xs font-semibold text-green-400 tracking-widest uppercase border border-green-400/20 bg-gray-400/10 rounded-full px-3 py-1.5 mb-5">
                {role.label}
              </span>
              ...
              <ul className="space-y-3">
                {role.perks.map((p) => (
                  <li key={p} className="flex gap-3 text-sm text-stone-400">
                    <span className="mt-0.5 min-w-4 h-4 bg-ray-400/10 border border-gray-400/20 flex items-center justify-center text-xs text-green-400">
                      ✓
                    </span>
                    {p}
                  </li>
      ...
      {/* CTA */}
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="relative border border-gray-400/20 rounded-3xl px-3 sm:px-16 py-20 bg-linear-to-br from-gray-400/5 text-center overflow-hidden">
          < FireworksBackgroundDemo />
          ...
          <h2 className="font-serif relative text-4xl md:text-5xl leading-tight tracking-tight mb-4">
            ...
            <br />
            <GreenTitle>starts here</GreenTitle>
          </h2>

          <p className="relative text-stone-400 font-light text-sm mb-11">
            Join thousands of engineers already levelling up on MockMate.
          </p>
