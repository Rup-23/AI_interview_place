...
export const GrayTitle = ({ children }) => <span className="bg-linear-to-br from-stone-100 via-stone-300 to-stone-500 bg-clip-text text-transparent">
    {children}
</span>
export const GreenTitle = ({ children }) => <span className="bg-linear-to-br from-green-300 via-green-600 to-green-800 bg-clip-text text-transparent">
    {children}
</span>
export const SectionLabel = ({ children }) => (
    <p className="inline-flex items-center gap-2 text-xs font-semibold text-green-400 tracking-[0.14em] uppercase mb-4">
